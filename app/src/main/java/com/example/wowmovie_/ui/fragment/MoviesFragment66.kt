...
class MoviesFragment66 : Fragment(R.layout.fragment_movies66) {

    lateinit var repository: MovieRepository
    var id = ""
val args: MoviesFragment66Args by navArgs()
    ...
    private fun initViews(view: View) {
        ...
        ll = view.findViewById(R.id.ll_66)
        ivSave = view.findViewById(R.id.iv_Save66)
        ...
        back.setOnClickListener {
            findNavController().navigate(R.id.action_moviesFragment66_to_topMoviesFragment)
        }
        adapter.onClick={
            findNavController().navigate(R.id.action_moviesFragment66_self,
                bundleOf("topmovieId" to it.toString())
            )
        }
