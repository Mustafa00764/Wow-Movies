...
class MoviesFragment55 : Fragment(R.layout.fragment_movies55) {
    lateinit var repository: MovieRepository
    var id = ""
val args: MoviesFragment55Args by navArgs()
    ...
    private fun initViews(view: View) {
        ...
        progresBar = view.findViewById(R.id.prgBarMovies55)
        ...
        ll = view.findViewById(R.id.ll_55)
        ivSave = view.findViewById(R.id.iv_Save55)
        ...
        val back = view.findViewById<ImageView>(R.id.iv_back2222)
        back.setOnClickListener {
            findNavController().navigate(R.id.action_moviesFragment55_to_popularMoviesFragment)
        }
        adapter.onClick={
            findNavController().navigate(R.id.action_moviesFragment55_self,
                bundleOf("movie3Id" to it.toString())
            )
        }
