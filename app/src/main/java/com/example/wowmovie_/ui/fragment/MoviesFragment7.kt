...
class MoviesFragment7 : Fragment(R.layout.fragment_movies7) {
    lateinit var repository: MovieRepository
    var id = ""
val args: MoviesFragment7Args by navArgs()
    ...
    private fun initViews(view: View) {
        ...
        progresBar = view.findViewById(R.id.prgBarMovies7)

        id=args.searchmovieId
        main = ArrayList()
        movies = ArrayList()
        ...
        ll = view.findViewById(R.id.ll_7)
        ivSave = view.findViewById(R.id.iv_Save7)
        ...
        val back = view.findViewById<ImageView>(R.id.iv_back2227)
        back.setOnClickListener {
            findNavController().navigate(R.id.action_moviesFragment7_to_loadingFragment)
        }
        adapter.onClick={
            findNavController().navigate(R.id.action_moviesFragment7_self2,
                bundleOf("searchmovieId" to it.toString())
            )
        }
