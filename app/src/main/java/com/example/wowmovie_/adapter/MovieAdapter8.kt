...
class MovieAdapter8(
) : RecyclerView.Adapter<MovieAdapter8.MovieViewHolder>() {

    //    private val collection: ArrayList<ResultsItem> = ArrayList()
    var itemClick: ((Int) -> Unit)? = null
    var itemClick1: ((Int) -> Unit)? = null
    private val movieTopResult = ArrayList<UpcomingRUItem>()
    fun submitLists(movieTopResult: ArrayList<UpcomingRUItem>) {
